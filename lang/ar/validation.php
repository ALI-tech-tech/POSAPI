...
return [
    ...
    'ascii' => 'يجب أن يحتوي حقل :attribute على أحرف أبجدية أحادية البايت ورموزًا.',
    ...
    'hex_color' => 'يجب أن يكون حقل :attribute لون هكساديسيمال صالح.',
    ...
    'password' => [
        ...
        'uncompromised' => 'تم ظهور القيمة المُدخلة لحقل :attribute في تسريب بيانات. يرجى اختيار قيمة مختلفة لـ :attribute.',
    ],
    ...
    'prohibited' => 'منع حقل :attribute.',
    'prohibited_if' => 'منع حقل :attribute عندما يكون :other هو :value.',
    'prohibited_unless' => 'منع حقل :attribute ما لم يكن :other هو :values.',
